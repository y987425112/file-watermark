...
public class PptHandle {
	 ...
	 public static final int WORD_HTML = 8;  
	    ...
	    private ActiveXComponent pptCom;  
	    private ActiveXComponent presentation;  
	 // 声明ppt文档对象  
	    private Dispatch ppt = null; 
	    // 声明所有ppt文档集合对象  
	    private Dispatch pptDocs = null;  
	 // 声明ppt文档选定区域或插入点对象  
	    private Dispatch pptSelection = null;
	    //活动窗口
	     ...
	     * @param isVisble 
	     */  
	    public PptHandle(boolean isVisble){  
	        if(null == pptCom){  
	            pptCom = new ActiveXComponent("PowerPoint.Application");  
	           // pptCom.setProperty("Visible", new Variant(isVisble));  
	            ActiveXComponent presentations = pptCom.getPropertyAsComponent("Presentations");  
	            presentation =presentations.invokeGetComponent("Add", new Variant(1)); 
	            
	            pptDocs = pptCom.getProperty("Presentations").toDispatch();  
	        }  
	    }  
//	    public PptHandle(String filePath,boolean isVisble)throws Exception{  
...
//	    } 
	    ...
	    public void openPpt(String filePath) {
	    	...
	    	this.ppt = Dispatch.call(pptDocs, "Open", filePath).toDispatch();  
	    	//Dispatch window = Dispatch.call(windows, "Item", new Variant(1)).toDispatch();  
	        this.pptSelection = Dispatch.get(activeWindow, "Selection").toDispatch();
	    ...
	    public void closeDocument() {  
	        if (this.ppt != null) {  
	            Dispatch.call(this.ppt, "Save");  
	            Dispatch.call(this.ppt, "Close", new Variant(true));  
	            this.ppt = null;  
	        } 
	...
	/** 
	    ...
	    public void getActiveWindow() {  
	        // 获得活动窗体对象  
//	        activeWindow = pptCom.getProperty("ActiveWindow").toDispatch();  
	        activeWindow = pptCom.getProperty("Windows").toDispatch();  
	    }  
	    public void setWaterMark2(String waterMarkStr)
	    {
	        ...
	        Dispatch headfooter = Dispatch.get(pptSelection, "HeaderFooter")
	              .toDispatch();
	        //取得图形对象
	        ...
	        //设置水印参数
	        Dispatch shapeRange = Dispatch.get(pptSelection, "ShapeRange")
	              .toDispatch();
	    ...
	    public static void main(String[] strs)throws Exception{  
	        ...
	        PptHandle jac = new PptHandle(false);  
	        jac.openPpt(filePath);
	        jac.getActiveWindow();
	        jac.setWaterMark2("helloWord");
	        jac.closeDocument();
//	        jac.closePpt();
//	        jac.getGeneragePpt();  
